...
export default function Tentang() {
  ...
  const values = [
    {
      ...
      title: "Excellence",
      description:
        "Kami berkomitmen memberikan hasil terbaik dalam setiap proyek dengan standar kualitas tinggi",
    },
    {
      icon: Heart,
      title: "Client-Centric",
      description:
        "Kepuasan klien adalah prioritas utama. Kami mendengarkan dan memahami kebutuhan Anda",
    },
    {
      icon: Lightbulb,
      title: "Innovation",
      description:
        "Selalu menggunakan teknologi terkini dan pendekatan inovatif untuk solusi terdepan",
    },
    {
      icon: Shield,
      title: "Reliability",
      description:
        "Tim yang dapat diandalkan dengan komunikasi transparan dan delivery tepat waktu",
    },
  ];
  ...
  const achievements = [
    {
      ...
      description:
        "Telah menyelesaikan berbagai proyek dari startup hingga enterprise",
    },
    {
      icon: Users,
      title: "30+ Klien Puas",
      description:
        "Klien dari berbagai industri yang memberikan testimoni positif",
    },
    {
      icon: Star,
      title: "4.9/5 Rating",
  ...
  const technologies = [
    ...
    },
    {
      category: "Backend",
      icon: Database,
      techs: ["Node.js", "Laravel", "Django", "Express", "Fastify"],
    },
    {
      category: "Mobile",
      icon: Zap,
      techs: ["React Native", "Flutter", "iOS Native", "Android Native"],
    },
    {
      category: "Design",
      icon: Palette,
      techs: ["Figma", "Adobe XD", "Sketch", "Principle", "Framer"],
    },
  ];
          ...
          <div className="text-center">
            ...
            <h1 className="text-xl md:text-3xl font-semibold text-gray-800 mb-3 leading-tight">
              ...
              <span className="text-primary block">
                Ide Digital Menjadi Kenyataan
              </span>
            </h1>
            <p className="text-sm md:text-base text-gray-600 mb-5 max-w-3xl mx-auto leading-relaxed">
              DigitalAgensi adalah partner terpercaya untuk transformasi digital
              perusahaan Anda. Dengan pengalaman 5+ tahun, kami telah membantu
              berbagai bisnis mencapai tujuan digitalnya.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="border-0 shadow-sm bg-gradient-to-br from-primary/5 to-orange-50">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Menjadi agensi digital terdepan di Indonesia yang menghadirkan
                  solusi teknologi inovatif dan berkualitas tinggi untuk
                  membantu bisnis bertransformasi dan berkembang di era digital.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-sm bg-gradient-to-br from-orange-50 to-primary/5">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Memberikan solusi digital terbaik melalui teknologi terkini,
                  desain yang user-centric, dan layanan yang excellent untuk
                  membantu klien mencapai tujuan bisnis mereka dengan efektif
                  dan efisien.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-gray-600 max-w-3xl mx-auto">
              Tim berpengalaman dengan passion tinggi untuk menciptakan solusi
              digital terbaik
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-gray-600 max-w-3xl mx-auto">
              Menggunakan teknologi terkini dan terbukti untuk membangun solusi
              yang robust dan scalable
            </p>
          </div>
