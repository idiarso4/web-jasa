        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                size="default"
                className="text-sm px-6 py-2.5 bg-gradient-to-r from-primary to-orange-500 hover:from-primary/90 hover:to-orange-500/90 shadow-lg"
                asChild
              >
                <Link to="/kontak">
              ...
              <Button
                size="default"
                variant="outline"
                className="text-sm px-6 py-2.5 border-primary text-primary hover:bg-primary hover:text-white"
                asChild
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button
              size="default"
              variant="outline"
              className="text-sm px-6 py-3 border-white text-white hover:bg-white hover:text-primary"
              asChild
            >
