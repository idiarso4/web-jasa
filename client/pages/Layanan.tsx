        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-xl md:text-3xl font-semibold text-gray-800 mb-3 leading-tight">
              ...
              <span className="text-primary block">untuk Setiap Kebutuhan Bisnis</span>
            </h1>
            <p className="text-sm md:text-base text-gray-600 mb-5 max-w-3xl mx-auto leading-relaxed">
              ...
              dan metodologi yang terbukti efektif untuk membantu bisnis Anda berkembang.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <Card key={index} className="h-full border-0 shadow-sm hover:shadow-lg transition-all duration-300">
                <CardHeader className="pb-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <CardTitle className="text-lg font-medium mb-2">{service.title}</CardTitle>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <h4 className="font-medium text-sm mb-3 text-gray-800">Fitur Yang Termasuk:</h4>
                  ...
                  <div className="border-t pt-4 space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm font-medium text-gray-700">{service.timeline}</span>
                    </div>
                  </div>
                  <Button className="w-full text-sm bg-gradient-to-r from-primary to-orange-500 hover:from-primary/90 hover:to-orange-500/90" asChild>
                    <Link to="/kontak">
                      Konsultasi Gratis
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-gray-600 max-w-3xl mx-auto">
              Proses pengembangan yang terstruktur dan transparan untuk memastikan hasil terbaik
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary to-orange-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm text-primary-foreground/80 mb-5 max-w-2xl mx-auto">
            Diskusikan kebutuhan proyek Anda dengan tim ahli kami dan dapatkan konsultasi gratis
          </p>
