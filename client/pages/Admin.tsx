...
export default function Admin() {
  ...
  const recentProjects = [
    {
      ...
      clientAvatar: "https://images.pexels.com/photos/7688336/pexels-photo-7688336.jpeg",
      status: "development",
      progress: 75,
      deadline: "2024-03-15",
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      case 'Enterprise System': return Shield;
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Welcome back, {user?.name}! Here's what's happening with your agency.
              </p>
            </div>
                      ...
                      {recentActivities.map((activity) => (
                        <div key={activity.id} className="flex items-start space-x-3">
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white text-xs ${
                            ...
                            {activity.type === 'feedback' ? <MessageSquare className="h-3 w-3" /> :
                             activity.type === 'milestone' ? <CheckCircle className="h-3 w-3" /> :
                             activity.type === 'issue' ? <AlertCircle className="h-3 w-3" /> :
                        ...
                        <div key={index} className="flex items-center space-x-3">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center mt-1">
                              <Progress value={member.workload} className="h-1 w-16 mr-2" />
          ...
          <TabsContent value="projects" className="space-y-6">
            <Card className="border-0 shadow-sm">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-lg font-medium">All Projects</CardTitle>
                    <CardDescription className="text-sm">
                    ...
                    {recentProjects.map((project) => {
                      ...
                      return (
                        <TableRow key={project.id}>
                          ...
                          <TableCell>
                            <span className="text-sm">{new Date(project.deadline).toLocaleDateString('id-ID')}</span>
                          </TableCell>
                          <TableCell>
                  ...
                  <TableBody>
                    {recentClients.map((client) => (
                      <TableRow key={client.id}>
                        ...
                        <TableCell>
                          <span className="text-sm font-medium">{client.totalValue}</span>
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          <span className="text-sm">{new Date(client.joinDate).toLocaleDateString('id-ID')}</span>
                        </TableCell>
                        <TableCell>
                          <Button size="sm" variant="ghost" className="h-6 w-6 p-0">
                            <MoreHorizontal className="h-3 w-3" />
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <Badge variant="outline" className="text-xs">{member.projects}</Badge>
                      </div>
