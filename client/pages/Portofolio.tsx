  ...
  const portfolioProjects = [
    {
      ...
      description:
        "Platform jual beli online dengan sistem pembayaran terintegrasi, manajemen inventory, dan dashboard admin yang komprehensif",
      image:
        "https://images.pexels.com/photos/29502353/pexels-photo-29502353.jpeg",
    ...
    },
    {
      ...
      description:
        "Aplikasi komprehensif untuk manajemen pasien, dokter, jadwal, dan administrasi rumah sakit dengan fitur telemedicine",
      image:
        "https://images.pexels.com/photos/6823602/pexels-photo-6823602.jpeg",
    ...
    },
    {
      ...
      description:
        "Aplikasi mobile untuk layanan pengantaran makanan real-time dengan tracking GPS dan sistem rating",
      image:
    ...
    },
    {
      ...
      description:
        "Customer Relationship Management system untuk perusahaan sales dengan automation dan analytics",
      image:
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-sm md:text-base text-gray-600 mb-5 max-w-3xl mx-auto leading-relaxed">
              Jelajahi koleksi proyek sukses kami yang mencakup berbagai
              industri dan teknologi. Setiap proyek dirancang dengan solusi
              inovatif dan hasil yang terukur.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="text-xl md:text-2xl font-semibold bg-gradient-to-r from-primary to-orange-500 bg-clip-text text-transparent mb-1">
                  {stat.number}
                </div>
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    <Button
                      size="sm"
                      className="flex-1 text-xs bg-gradient-to-r from-primary to-orange-500 hover:from-primary/90 hover:to-orange-500/90"
                    >
      ...
      <section className="py-16 bg-gradient-to-r from-primary to-orange-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm text-primary-foreground/80 mb-5 max-w-2xl mx-auto">
            Mari diskusikan ide Anda dan wujudkan solusi digital yang dapat
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              ...
              asChild
            >
              <Link to="/kontak">Mulai Proyek Baru</Link>
            </Button>
            <Button
              size="default"
              variant="outline"
